/*************************************************************************
	> File Name: dualview.c
	> Author: 
	> Mail: 
	> Created Time: Tue Sep 10 09:57:15 2019
 ************************************************************************/

/* Listing 14.5 -- bit fields and bitwise operators
 */
#include <stdio.h>
#include <iso646.h>
#include <stdbool.h>
...
int main(void) {
    ...
    char bit_str[8 * sizeof(unsigned int) + 1];
